...
<header>
    ...
    <div class="border-bottom">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="#" class="nav-link active disabled">Alta alumno</a></li>
        </ul>
    </div>
</header>
...
<main>
    <div class="container">
        <div class="h2">Registrar usuario - Alumno</div>
        <c:choose>
            <c:when test="${listaProfesores !=null}">
                <form action="all" method="POST" class="needs-validation">
                    <input type="text" name="accion" value="altaAlumno" hidden/>
                    <div class="row g-3">
                        <div class="col-12">
